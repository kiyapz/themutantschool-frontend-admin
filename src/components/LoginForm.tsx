...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authApiUrl.post("login", formData);
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="flex" style={{ gap: "var(--spacing-md)" }}>
          ...
          <button
            type="button"
            className="bg-white border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors flex items-center justify-center"
            style={{ padding: "var(--spacing-md)", gap: "var(--spacing-sm)" }}
          >
